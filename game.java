...
import java.util.Random;
    ...
    public  class game extends JFrame implements  ActionListener {
        ...
        public game() {
            ...
            //bottompanal.setLayout(new FlowLayout());
            bottompanal.add(new JButton("RESET"));
            bottompanal.add(new JButton("EXIT"));
            add(bottompanal, BorderLayout.SOUTH);
            topPanel.setLayout(new FlowLayout());
            topPanel.add(new JLabel("Tic Tac Toe Game"));
